...
#[derive(Debug)]
pub struct EmberZephyrProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EmberZephyrProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EmberZephyr processing");
    
    let mut processor = EmberZephyrProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EmberZephyrProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EmberZephyrProcessor::new(false);
